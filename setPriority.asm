  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  16:	8b 71 04             	mov    0x4(%ecx),%esi
    if(argc<3)
  19:	7e 63                	jle    7e <main+0x7e>
  1b:	8b 56 04             	mov    0x4(%esi),%edx
    {
  ...
  20:	eb 17                	jmp    39 <main+0x39>
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    {
        if(argv[1][i]<'0'||argv[1][i]>'9')
  28:	8b 56 04             	mov    0x4(%esi),%edx
  2b:	0f b6 04 1a          	movzbl (%edx,%ebx,1),%eax
  2f:	83 e8 30             	sub    $0x30,%eax
  32:	3c 09                	cmp    $0x9,%al
  34:	77 5b                	ja     91 <main+0x91>
    for(int i=0;i<strlen(argv[1]);i++)
  36:	83 c3 01             	add    $0x1,%ebx
  39:	83 ec 0c             	sub    $0xc,%esp
  3c:	52                   	push   %edx
  3d:	e8 0e 01 00 00       	call   150 <strlen>
  42:	83 c4 10             	add    $0x10,%esp
  45:	39 d8                	cmp    %ebx,%eax
  47:	77 df                	ja     28 <main+0x28>
        {
  ...
  4c:	ff 76 04             	pushl  0x4(%esi)
  4f:	e8 5c 02 00 00       	call   2b0 <atoi>
  54:	89 c3                	mov    %eax,%ebx
    int pid = atoi(argv[2]);
  56:	58                   	pop    %eax
  57:	ff 76 08             	pushl  0x8(%esi)
  5a:	e8 51 02 00 00       	call   2b0 <atoi>
    if(pid==0)
  5f:	83 c4 10             	add    $0x10,%esp
  62:	85 c0                	test   %eax,%eax
  64:	74 4c                	je     b2 <main+0xb2>
    {
        printf(1,"Invalid pid\n");
        exit();
    }
    if(new_priority<0||new_priority>100)
  66:	83 fb 64             	cmp    $0x64,%ebx
  69:	76 39                	jbe    a4 <main+0xa4>
    {
        printf(1,"Value of newpriority is out of bounds\n");
  6b:	51                   	push   %ecx
  6c:	51                   	push   %ecx
  6d:	68 14 08 00 00       	push   $0x814
  72:	6a 01                	push   $0x1
  74:	e8 07 04 00 00       	call   480 <printf>
        exit();
  79:	e8 a4 02 00 00       	call   322 <exit>
        printf(1,"Invalid number of arguments\n");
  7e:	50                   	push   %eax
  7f:	50                   	push   %eax
  80:	68 d8 07 00 00       	push   $0x7d8
  85:	6a 01                	push   $0x1
  87:	e8 f4 03 00 00       	call   480 <printf>
        exit();
  8c:	e8 91 02 00 00       	call   322 <exit>
            printf(1,"Invalid command\n");
  91:	50                   	push   %eax
  92:	50                   	push   %eax
  93:	68 f5 07 00 00       	push   $0x7f5
  98:	6a 01                	push   $0x1
  9a:	e8 e1 03 00 00       	call   480 <printf>
            exit();
  9f:	e8 7e 02 00 00       	call   322 <exit>
    }
  ...
  a6:	50                   	push   %eax
  a7:	53                   	push   %ebx
  a8:	e8 1d 03 00 00       	call   3ca <set_priority>
    exit();
  ad:	e8 70 02 00 00       	call   322 <exit>
        printf(1,"Invalid pid\n");
  b2:	53                   	push   %ebx
  b3:	53                   	push   %ebx
  b4:	68 06 08 00 00       	push   $0x806
  b9:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb 3c 08 00 00       	mov    $0x83c,%ebx
        while(*s != 0){
 ...
 651:	a1 f0 0a 00 00       	mov    0xaf0,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 f0 0a 00 00       	mov    %eax,0xaf0
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 f0 0a 00 00       	mov    %eax,0xaf0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 f0 0a 00 00    	mov    0xaf0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 f0 0a 00 00    	mov    %edx,0xaf0
}
 ...
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 f0 0a 00 00 f4 	movl   $0xaf4,0xaf0
 7a7:	0a 00 00 
 7aa:	c7 05 f4 0a 00 00 f4 	movl   $0xaf4,0xaf4
 7b1:	0a 00 00 
    base.s.size = 0;
 7b4:	b8 f4 0a 00 00       	mov    $0xaf4,%eax
 7b9:	c7 05 f8 0a 00 00 00 	movl   $0x0,0xaf8
 7c0:	00 00 00 
