  ...
  12:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  18:	7e 5c                	jle    76 <main+0x76>
    ...
    int pid=fork();
  1a:	e8 cb 02 00 00       	call   2ea <fork>
    if(pid<0)
  1f:	85 c0                	test   %eax,%eax
  21:	78 66                	js     89 <main+0x89>
    {
        printf(1,"fork failed\n");
        exit();
    }
    else if(pid==0)
  23:	74 29                	je     4e <main+0x4e>
        }
    }
    else
    {
  ...
  2e:	50                   	push   %eax
  2f:	e8 5e 03 00 00       	call   392 <waitx>
        // printf(1,"%p %p\n",&wtime,&rtime);
        printf(1,"wating time: %d running time: %d\n",wtime,rtime);
  34:	ff 75 f4             	pushl  -0xc(%ebp)
  37:	ff 75 f0             	pushl  -0x10(%ebp)
  3a:	68 e4 07 00 00       	push   $0x7e4
  3f:	6a 01                	push   $0x1
  41:	e8 0a 04 00 00       	call   450 <printf>
  46:	83 c4 20             	add    $0x20,%esp
    }
    exit();
  49:	e8 a4 02 00 00       	call   2f2 <exit>
        if(exec(argv[1],argv+1)<0)
  4e:	8d 43 04             	lea    0x4(%ebx),%eax
  51:	51                   	push   %ecx
  52:	51                   	push   %ecx
  53:	50                   	push   %eax
  54:	ff 73 04             	pushl  0x4(%ebx)
  57:	e8 ce 02 00 00       	call   32a <exec>
  5c:	83 c4 10             	add    $0x10,%esp
  5f:	85 c0                	test   %eax,%eax
  61:	79 e6                	jns    49 <main+0x49>
            printf(1,"Invalid command\n");
  63:	52                   	push   %edx
  64:	52                   	push   %edx
  65:	68 d2 07 00 00       	push   $0x7d2
  6a:	6a 01                	push   $0x1
  6c:	e8 df 03 00 00       	call   450 <printf>
            exit();
  71:	e8 7c 02 00 00       	call   2f2 <exit>
        printf(1,"Invalid number of arguments\n");
  76:	50                   	push   %eax
  77:	50                   	push   %eax
  78:	68 a8 07 00 00       	push   $0x7a8
  7d:	6a 01                	push   $0x1
  ...
  90:	6a 01                	push   $0x1
  92:	e8 b9 03 00 00       	call   450 <printf>
        exit();
  97:	e8 56 02 00 00       	call   2f2 <exit>
  9c:	66 90                	xchg   %ax,%ax
  9e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb 08 08 00 00       	mov    $0x808,%ebx
        while(*s != 0){
 ...
 621:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 b8 0a 00 00       	mov    %eax,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 b8 0a 00 00    	cmp    %eax,0xab8
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 777:	0a 00 00 
 77a:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 bc 0a 00 00       	mov    $0xabc,%eax
