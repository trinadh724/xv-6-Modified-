...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 68 07 00 00       	mov    $0x768,%ebx
        while(*s != 0){
 ...
 5c1:	a1 14 0a 00 00       	mov    0xa14,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 14 0a 00 00       	mov    %eax,0xa14
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
 ...
 616:	72 ce                	jb     5e6 <free+0x26>
{
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 14 0a 00 00       	mov    %eax,0xa14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 14 0a 00 00    	mov    %edx,0xa14
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 14 0a 00 00 18 	movl   $0xa18,0xa14
 717:	0a 00 00 
 71a:	c7 05 18 0a 00 00 18 	movl   $0xa18,0xa18
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 18 0a 00 00       	mov    $0xa18,%eax
 729:	c7 05 1c 0a 00 00 00 	movl   $0x0,0xa1c
 730:	00 00 00 
